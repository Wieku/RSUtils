...
@RSCommand(command = "unmute", description="Odcisza gracza")
public class CommandUnMute implements Command{
	...
	public void exec(CommandSender sender, String command, Arguments args) {
		...
		if(sender instanceof Player){
			if(!RSUtils.getUser((Player)sender).hasPermission("rsutils.unmute")){
				return;
			}
		}
		...
		YAML.set(YAML.type.BANS, name + ".mute", null);
